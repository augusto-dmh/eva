...
class UpdateCollaboratorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'cpf' => ['required', 'string', 'size:14', Rule::unique('collaborators')->ignore($collaborator)],
            'email_corporativo' => ['required', 'email', Rule::unique('collaborators')->ignore($collaborator)],
